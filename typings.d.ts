declare module "@vahesaroyan/redux-offline/lib/defaults" {
  import { Config } from "@vahesaroyan/redux-offline/lib/types";

  const config: Config;
  export default config;
}

declare module "@vahesaroyan/redux-offline/lib/types" {
...
declare module "@vahesaroyan/redux-offline/lib/constants" {
...
declare module "@vahesaroyan/redux-offline" {
  import { createStore as createReduxStore, Middleware, Store, StoreEnhancer } from "redux";
